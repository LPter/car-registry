        ...
        <>
            <footer className="footer">
                {/* <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10"> */}
                    <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-4">
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Về chúng tôi</h3>
                            <ul className="text-gray-500 dark:text-gray-400">
                                ...
                                <li className="mb-4">
                                    <a href="#" className="hover:underline">Địa chỉ</a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Liên hệ</h3>
                            <ul className="text-gray-500 dark:text-gray-400">
                                <li className="mb-4">
                        ...
                        <div>
                            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Chính sách</h3>
                            <ul className="text-gray-500 dark:text-gray-400">
                                <li className="mb-4">
                    ...
                    <div className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8">
                        <div className="text-center">
                            <a href="#" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                                <img src="/logoweb.png" className="h-16 mr-3 sm:h-9" alt="Landwind Logo" />
                                CaRegistree
                            </a>
                            <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023 CaRegistree™. All Rights Reserved.</span>
            ...
            <div className="footer">
                <div className="container px-4 sm:px-8">
                    <h4 className="mb-8 lg:max-w-3xl lg:mx-auto">CaRegistree là một ứng dụng thuộc Cục Đăng Kiểm Việt Nam <a className="text-indigo-600 hover:text-gray-500" href="mailto:email@domain.com">email@domain.com</a></h4>
            ...
            <div className="copyright">
                <div className="container px-4 sm:px-8 lg:grid lg:grid-cols-3">
                    ...
                    <p className="pb-2 p-small statement">Distributed by :<a href="https://themewagon.com/" className="no-underline">Group 22</a></p>
                </div>
