  ...
  return (
    <div className="absolute top-0 right-0 w-40 text-right ">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-20 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 p-0.5 md:p-1 lg:p-2">
            Statistics by
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    onClick={() => {
                      setMenuDropdownValue('month');
                      props.onDataUpdate('month');
                    }}
                  >
                    Month
                  </button>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    onClick={() => {
                      setMenuDropdownValue('quarter');
                      props.onDataUpdate('quarter');
                    }}
                  >
                    Quarter
                  </button>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    onClick={() => {
                      setMenuDropdownValue('year');
                      props.onDataUpdate('year');
                    }}
                  >
                    Year
                  </button>
